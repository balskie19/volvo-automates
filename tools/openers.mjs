...
.stamp{position:absolute;right:-1%;top:100%;margin-top:-15px;
...
.sub{margin-top:clamp(28px,min(4vw,6.6vh),72px);font-family:var(--f-disp);font-weight:900;
...
@media(max-width:560px){
  ...
  .sub{font-size:clamp(27px,8.6vw,44px);margin-top:34px}
  ...
  .stamp{right:-2%;top:100%;margin-top:-11px;font-size:clamp(15px,4.8vw,22px);padding:7px 13px}}`;
